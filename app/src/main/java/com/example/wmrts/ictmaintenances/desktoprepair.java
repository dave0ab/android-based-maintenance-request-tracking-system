...
public class desktoprepair extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desktoprepair);
        ...
        navigationView.setNavigationItemSelectedListener(desktoprepair.this);
    ...
    UploadImageToServer();
                Intent myIntent = new Intent(desktoprepair.this, statuscheck.class);
                desktoprepair.this.startActivity(myIntent);
            }

        });

        if (ContextCompat.checkSelfPermission(desktoprepair.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            if (ContextCompat.checkSelfPermission(desktoprepair.this, android.Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(desktoprepair.this, new String[]{android.Manifest.permission.POST_NOTIFICATIONS},101);
            }
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(desktoprepair.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(desktoprepair.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(desktoprepair.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
               ...
               randonString = RandomStringUtils.randomAlphanumeric(16);
                desktoprepair.ImageProcessClass imageProcessClass = new desktoprepair.ImageProcessClass();
                ...
                checkinstallantivirus1 =findViewById(R.id.check3);
                checkinstallsoftware1 =findViewById(R.id.check4);
                checkpcformat1=findViewById(R.id.check5);
                checkinstallmsoffice1 =findViewById(R.id.check6);
                ...
                if(checkinstallantivirus1.isChecked()){c3=checkinstallantivirus1.getText().toString();}
                if(checkinstallsoftware1.isChecked()){c4=checkinstallsoftware1.getText().toString();}
                if(checkpcformat1.isChecked()){c5=checkpcformat1.getText().toString();}
                if(checkinstallmsoffice1.isChecked()){c6=checkinstallmsoffice1.getText().toString();}


             String concatenate = c1+"&"+c2+"&"+c3+"&"+c4+"&"+c5+"&"+c6;

              // String ccc= concat(c1, c2, c3, c4,c5,c6).toString();


           //     TextView concat=findViewById(R.id.concat);



      //         concat.setText(concatenate);
                ...
                HashMapParams.put("name", desktoprepair.this.fname);
                HashMapParams.put("officeno",offficeno .getText().toString());

                HashMapParams.put("pcmodel",pcmodel.getText().toString());

                HashMapParams.put("quantity" ,quantity.getText().toString());
                HashMapParams.put("phone" ,desktoprepair.this.mobilenum);
                ...
                String FinalData = imageProcessClass.ImageHttpRequest(url+"request/request.php", HashMapParams);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5 ||requestCode == 101  ) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(desktoprepair.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(desktoprepair.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(desktoprepair.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(desktoprepair.this);
