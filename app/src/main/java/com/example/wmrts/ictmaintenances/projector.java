...
import static com.example.wmrts.R.*;
...
public class projector extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_projector);
        ...
        navigationView.setNavigationItemSelectedListener(projector.this);
...
userinfo();
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String a =tvb.getText().toString();
                    ...
                    UploadImageToServer();
                Intent myIntent = new Intent(projector.this, statuscheck.class);
                projector.this.startActivity(myIntent);
        ...
        if (ContextCompat.checkSelfPermission(projector.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(projector.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(projector.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(projector.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                projector.ImageProcessClass imageProcessClass = new projector.ImageProcessClass();
                ...
                HashMapParams.put("name", projector.this.fname);
                HashMapParams.put("officeno",offficeno .getText().toString());
                HashMapParams.put("phone" ,projector.this.mobilenum);
                ...
                HashMapParams.put("device" ,"Projector");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(projector.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(projector.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(projector.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(projector.this);
