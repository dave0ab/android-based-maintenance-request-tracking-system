...
public class scanner extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(scanner.this);
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    UploadImageToServer();
                Intent myIntent = new Intent(scanner.this, statuscheck.class);
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(scanner.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(scanner.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                scanner.ImageProcessClass imageProcessClass = new scanner.ImageProcessClass();
                ...
                HashMapParams.put("name", scanner.this.fname);

                HashMapParams.put("phone" ,scanner.this.mobilenum);
                HashMapParams.put("additionalmessage",additional.getText().toString());
                HashMapParams.put("facility", "ICT");
                HashMapParams.put("device" ,"Scanner");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(scanner.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(scanner.this).load(impath).into(image);
