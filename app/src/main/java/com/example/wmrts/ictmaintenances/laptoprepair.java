...
public class laptoprepair extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laptoprepair);
        ...
        navigationView.setNavigationItemSelectedListener(laptoprepair.this);
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    UploadImageToServer();
                Intent myIntent = new Intent(laptoprepair.this, statuscheck.class);
                laptoprepair.this.startActivity(myIntent);
            }
        });

        if (ContextCompat.checkSelfPermission(laptoprepair.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(laptoprepair.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(laptoprepair.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(laptoprepair.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                laptoprepair.ImageProcessClass imageProcessClass = new laptoprepair.ImageProcessClass();
                ...
                HashMapParams.put("name", laptoprepair.this.fname);
                ...
                HashMapParams.put("phone" ,laptoprepair.this.mobilenum);
                ...
                HashMapParams.put("device" ,"Laptop");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(laptoprepair.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(laptoprepair.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(laptoprepair.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(laptoprepair.this);
