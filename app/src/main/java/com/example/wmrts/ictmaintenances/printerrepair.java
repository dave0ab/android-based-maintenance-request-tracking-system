...
public class printerrepair extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printerrepair);
        ...
        navigationView.setNavigationItemSelectedListener(printerrepair.this);
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    UploadImageToServer();
                Intent myIntent = new Intent(printerrepair.this, statuscheck.class);
                printerrepair.this.startActivity(myIntent);
        ...
        if (ContextCompat.checkSelfPermission(printerrepair.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(printerrepair.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(printerrepair.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(printerrepair.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                printerrepair.ImageProcessClass imageProcessClass = new printerrepair.ImageProcessClass();
                ...
                HashMapParams.put("device" ,"Printer");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(printerrepair.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(printerrepair.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(printerrepair.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(printerrepair.this);
    ...
    void createNotificationChannel1(Context c){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notification = new Notification.Builder(c,CHANNEL_ID)
                    .setContentText( "You have assigned maintenance technician for you he will contact you thanks for your patience")
