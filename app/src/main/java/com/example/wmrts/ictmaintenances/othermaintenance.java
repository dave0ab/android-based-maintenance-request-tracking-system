...
public class othermaintenance extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    Button GetImageFromGalleryButton, UploadImageOnServerButton;
    public String fname;
    String id; ;String lname;String wuid;    String mobilenum;     String gender; String job_title;String status;    String impath  ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_othermaintenance);
        ...
        navigationView.setNavigationItemSelectedListener(othermaintenance.this);
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    UploadImageToServer();
                Intent myIntent = new Intent(othermaintenance.this, statuscheck.class);
                othermaintenance.this.startActivity(myIntent);
        ...
        if (ContextCompat.checkSelfPermission(othermaintenance.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(othermaintenance.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(othermaintenance.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(othermaintenance.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                othermaintenance.ImageProcessClass imageProcessClass = new othermaintenance.ImageProcessClass();
          ...
          //      if(checkpcformat1.isChecked()){c5=checkpcformat1.getText().toString();}
           //     if(checkinstallmsoffice1.isChecked()){c6=checkinstallmsoffice1.getText().toString();}
                ...
                String fname = othermaintenance.this.fname;
                HashMapParams.put("wuid", wuid);
                HashMapParams.put("buildingno", buildingno.getText().toString());
                HashMapParams.put("name", othermaintenance.this.fname);
                ...
                HashMapParams.put("phone" ,othermaintenance.this.mobilenum);
                HashMapParams.put("quantity" ,quantity.getText().toString());
                HashMapParams.put("department" , othermaintenance.this.job_title);
                ...
                HashMapParams.put("device" ,"Other");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(othermaintenance.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(othermaintenance.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(othermaintenance.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(othermaintenance.this);
