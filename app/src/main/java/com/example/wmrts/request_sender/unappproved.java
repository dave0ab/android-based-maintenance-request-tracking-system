...
public class unappproved extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_unappproved);
    ...
    public void onBackPressed() {
        ...
        if(bundle!= null)
        {
            ...
            Intent myIntent = new Intent(unappproved.this, statuscheck.class);
