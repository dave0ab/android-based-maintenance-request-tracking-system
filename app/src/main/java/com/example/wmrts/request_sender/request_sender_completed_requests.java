...
public class request_sender_completed_requests extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
Spinner task_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(request_sender_completed_requests.this);
task_status=findViewById(R.id.task_status);
      ...
      userinfo();
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        switch (i){
                            ...
                            case 0:
                                ...
                                Intent myIntent1 = new Intent(request_sender_completed_requests.this,detailrequestrequest_sender1.class);
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                retrieveclientData11(request_sender_completed_requests.this);
    ...
    public void retrieveclientData(){
        ...
        String urlrequest =url+ "request_sender/retrieve_completed_request_for_request_sender.php";
        StringRequest request = new StringRequest(Request.Method.POST, urlrequest,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            String report_stat= object.getString("report_status_client");
                            String b =task_status1.toLowerCase(Locale.ROOT);
                            String c =report_stat.toLowerCase(Locale.ROOT);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(request_sender_completed_requests.this, error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(request_sender_completed_requests.this);
    ...
    public void onBackPressed() {
        ...
        {
            Intent myIntent = new Intent(request_sender_completed_requests.this, request_sender_completed_requests.class);

          request_sender_completed_requests.this.startActivity(myIntent);
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                          ...
                          //  status = object.getString("workstatus");
                            ...
                            tv.setText(fname);
                            Picasso.with(request_sender_completed_requests.this).load(impath).into(image);
