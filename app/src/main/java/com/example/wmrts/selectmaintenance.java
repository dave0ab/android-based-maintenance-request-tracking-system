...
import com.example.wmrts.ictmaintenances.projector;
...
public class selectmaintenance extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
TextView txt1,txt2,txt3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customer_menu_dish);
   ...
   tv.setText(fname);
        ...
        navigationView.setNavigationItemSelectedListener(selectmaintenance.this);

userinfo();
        ImageView i =findViewById(R.id.menu_image1);
        ImageView i2 =findViewById(R.id.menu_image22);
        ImageView i3 =findViewById(R.id.menuimage3);
        ...
        i.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myIntent = new Intent(selectmaintenance.this, ictdirectoret.class);
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(selectmaintenance.this, construction_maintenances_request.class);
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(selectmaintenance.this, dormitory_maintenance_request.class);
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                retrieveclientData16(selectmaintenance.this);
    ...
    public void onBackPressed() {
        ...
        if(bundle!= null)
        {
            ...
            Intent myIntent = new Intent(selectmaintenance.this, statuscheck.class);
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlclient,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            TextView tv =findViewById(R.id.navfname);
                            tv.setText(fname);
                            Picasso.with(selectmaintenance.this).load(impath).into(image);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(selectmaintenance.this, error.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(selectmaintenance.this);
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        String    techname = object.getString("task_status");
                        int   a = Integer.parseInt(id);

                        editor = preferences1.edit();
                        preferences1 =getSharedPreferences("abcd", Context.MODE_PRIVATE);
                        String requestid = preferences1.getString("requestid", "");
                        String techn1 = preferences1.getString("task_status", "");
                        if(requestid.equals("")){
                            requestid = "0";
                            techn1 = "Not Assigned";
                        ...
                        if(techname.equals("Not Assigned")){
                            ...
                            if (a>reid) {
                                ...
                                if (reid == a) {
                                    ...
                                    } else if(techn1.equals("Assigned")){
