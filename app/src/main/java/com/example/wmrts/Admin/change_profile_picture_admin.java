...
public class change_profile_picture_admin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_profile_picture_admin);
        userinfo();
        ...
        navigationView.setNavigationItemSelectedListener(change_profile_picture_admin.this);
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ch.equals("n")) {
                    ...
                    Toast.makeText(change_profile_picture_admin.this, "Insert image", Toast.LENGTH_LONG).show();
                } else {


                    UploadImageToServer();
                    Intent myIntent = new Intent(change_profile_picture_admin.this, MainActivity.class);

                    change_profile_picture_admin.this.startActivity(myIntent);
        ...
        if (ContextCompat.checkSelfPermission(change_profile_picture_admin.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(change_profile_picture_admin.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(change_profile_picture_admin.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(change_profile_picture_admin.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
                ...
                String FinalData = imageProcessClass.ImageHttpRequest(url+"admin/change_profile_picture.php", HashMapParams);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(change_profile_picture_admin.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(change_profile_picture_admin.this).load(impath).into(image);
                        }
                    }
                }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(change_profile_picture_admin.this);
