...
public class listmaintenancerequest extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listmaintenancerequest);
        ...
        navigationView.setNavigationItemSelectedListener(listmaintenancerequest.this);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                CharSequence[] dialogItem = {"View Detail","Assign technician","Reject Request"};
...
if(a.equalsIgnoreCase("ictd101")){
    ...
    Intent  myIntent12 = new Intent(getApplicationContext(), detailrequest2.class);
    myIntent12.putExtra("position", position);

    myIntent12.putExtra("path", requestArrayList.get(position).getdocument_path());
    myIntent12.putExtra("rqst", requestArrayList.get(position).getId());
    listmaintenancerequest.this.startActivity(myIntent12);

}else {

    Intent  myIntent12 = new Intent(getApplicationContext(), detailrequest1.class);
    myIntent12.putExtra("position", position);
    ...
    listmaintenancerequest.this.startActivity(myIntent12);
                            ...
                            case 1:
                                ...
                                Intent myIntent1 = new Intent(listmaintenancerequest.this, assigntechnician.class);
                                myIntent1.putExtra("request_id", requestArrayList.get(position).getId());
                                myIntent1.putExtra("position", position);
                                myIntent1.putExtra("facility", requestArrayList.get(position).getfacility());
                                listmaintenancerequest.this.startActivity(myIntent1);
                            ...
                            case 2:
                                ...
                                deleteData(requestArrayList.get(position).getId());
                               Intent myIntent = new Intent(listmaintenancerequest.this, listmaintenancerequest.class);
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                retrieveclientData1(listmaintenancerequest.this);
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url+"facility_manager/reject.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(listmaintenancerequest.this, response, Toast.LENGTH_SHORT).show();
                        if(response.equals("Rejected")){
                            Toast.makeText(listmaintenancerequest.this, "Rejected Successfully", Toast.LENGTH_SHORT).show();
                        }
                        else{
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(listmaintenancerequest.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void retrieveclientData(){
        String url= getResources().getString(R.string.url1);
        String urlrequest = url+"facility_manager/retrieve_request.php";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(listmaintenancerequest.this);
        requestQueue.add(request);
    ...
    public void retrieveclientData1(String wuid123){
        String url= getResources().getString(R.string.url1);
        String urlrequest = url+"facility_manager/retrieve_request.php";
        StringRequest request = new StringRequest(Request.Method.POST, urlrequest,new Response.Listener<String>() {
            @Override
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(listmaintenancerequest.this).load(impath).into(image);
