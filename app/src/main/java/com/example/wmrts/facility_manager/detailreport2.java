...
import com.example.wmrts.maintenancetechnician.select_reported_requests1;
...
public class detailreport2 extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    Uri path;
    Bundle bundle1;
    String path1;
    ...
    int position;
    ImageView image;
    Button activate,deactivate,viewdocumnet,seen,reassign;
    public DrawerLayout drawerLayout;
    public ActionBarDrawerToggle actionBarDrawerToggle;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailreport2);
        ...
        navigationView.setNavigationItemSelectedListener(detailreport2.this);
 ...
 // imageview = findViewById(R.id.imageView);
        ...
        tvid.setText("ID: "+ select_reported_requests.reportArrayList.get(position).getId());
        tvwuid.setText("Technician ID: "+select_reported_requests.reportArrayList.get(position).gettech_wuid());
        tvname.setText("Request id: "+select_reported_requests.reportArrayList.get(position).getrequest_id());
        tvbuilding.setText("Message: "+select_reported_requests.reportArrayList.get(position).getmessage());
        tvoffice.setText("Reported date: "+select_reported_requests.reportArrayList.get(position).getreported_date());
        techphone.setText("Status: "+select_reported_requests.reportArrayList.get(position).getstatus());
...
reassign.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        builder.setMessage("Do you want to reassign this request ?");
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                retrieveclientData1(detailreport2.this);
    ...
    public void userinfo(){
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(detailreport2.this).load(impath).into(image);
                        }
                    }
                }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(detailreport2.this);
...
// Vibrate for 500 milliseconds
    ...
    public void  btnView() {
        ...
        //
        File file = new File(Environment.getExternalStorageDirectory() + "/" + "Download/"+  fileName);
        Uri uri = FileProvider.getUriForFile(detailreport2.this, "com.example.wumrts.provider", file);
    ...
    private void deleteData() {
        String url = getResources().getString(R.string.url1);
        StringRequest request = new StringRequest(Request.Method.POST, url+"facility_manager/status_seen_report.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(detailreport2.this, response, Toast.LENGTH_SHORT).show();
                        if(response.equals("seen")){
                            Toast.makeText(detailreport2.this, "Document seen", Toast.LENGTH_SHORT).show();
                        }
                        else{
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(detailreport2.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
    ...
    private void reassign() {
        String url = getResources().getString(R.string.url1);
        StringRequest request = new StringRequest(Request.Method.POST, url+"facility_manager/reassign_request.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(detailreport2.this, response, Toast.LENGTH_SHORT).show();
                        if(response.equals("Re-Assigned")){
                            Toast.makeText(detailreport2.this," Re-Assigned", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            //     Toast.makeText(Activate_reject_user.this, "Failed", Toast.LENGTH_SHORT).show();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("id", select_reported_requests.reportArrayList.get(position).getrequest_id());
                return params;
            }
        };
