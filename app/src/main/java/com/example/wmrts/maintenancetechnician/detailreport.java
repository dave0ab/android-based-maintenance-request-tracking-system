...
public class detailreport extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    Uri path;
    Bundle bundle1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailreport1);
        ...
        navigationView.setNavigationItemSelectedListener(detailreport.this);
 ...
 // imageview = findViewById(R.id.imageView);
        ...
        tvid.setText("ID: "+ select_reported_requests1.reportArrayList.get(position).getId());
        tvwuid.setText("Technician ID: "+ select_reported_requests1.reportArrayList.get(position).gettech_wuid());
        tvname.setText("Request id: "+ select_reported_requests1.reportArrayList.get(position).getrequest_id());
        tvbuilding.setText("Message: "+ select_reported_requests1.reportArrayList.get(position).getmessage());
        tvoffice.setText("Reported date: "+ select_reported_requests1.reportArrayList.get(position).getreported_date());
...
seen.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        t.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                retrieveclientData1(detailreport.this);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url+"facility_manager/status_seen_report.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(detailreport.this, response, Toast.LENGTH_SHORT).show();
                        if(response.equals("seen")){
                            Toast.makeText(detailreport.this, "Document seen", Toast.LENGTH_SHORT).show();
                        }
                        else{
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(detailreport.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
    ...
    public void userinfo(){
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(detailreport.this).load(impath).into(image);
                        }
                    }
                }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(detailreport.this);
        requestQueue.add(request);
    }
...
// Vibrate for 500 milliseconds
    ...
    public void  btnView() {
        ...
        //
        File file = new File(Environment.getExternalStorageDirectory() + "/" + "Download/"+  fileName);
        Uri uri = FileProvider.getUriForFile(detailreport.this, "com.example.wumrts.provider", file);
