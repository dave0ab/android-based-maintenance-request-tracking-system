...
public class change_profile_picture_technician extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_profile_picture_technician);
        userinfo();
        ...
        navigationView.setNavigationItemSelectedListener(change_profile_picture_technician.this);
...
public void onClick(View view) {
        ...
        Toast.makeText(change_profile_picture_technician.this, "Insert image", Toast.LENGTH_LONG).show();
        } else {


        UploadImageToServer();
        Intent myIntent = new Intent(change_profile_picture_technician.this, MainActivity.class);

        change_profile_picture_technician.this.startActivity(myIntent);
        ...
        if (ContextCompat.checkSelfPermission(change_profile_picture_technician.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
...
public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        e.printStackTrace();
        Toast.makeText(change_profile_picture_technician.this, "Failed!", Toast.LENGTH_SHORT).show();
        }
        }
...
class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
    ...
    protected void onPreExecute() {
        ...
        progressDialog = ProgressDialog.show(change_profile_picture_technician.this,"Image is Uploading","Please Wait",false,false);
    }
    ...
    protected void onPostExecute(String string1) {
        ...
        Toast.makeText(change_profile_picture_technician.this,string1,Toast.LENGTH_LONG).show();
    ...
    protected String doInBackground(Void... params) {
        ...
        String FinalData = imageProcessClass.ImageHttpRequest(url+"technician/change_profile_picture.php", HashMapParams);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 5) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(change_profile_picture_technician.this, "Unable to use Camera..Please Allow us to use Camera", Toast.LENGTH_LONG).show();
    ...
    public void userinfo(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlexpert,new Response.Listener<String>() {
                ...
                try{
                    ...
                    if(sucess.equals("1")){
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                            ...
                            tv.setText(fname);
                            Picasso.with(change_profile_picture_technician.this).load(impath).into(image);
                        }
                    }
                }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(change_profile_picture_technician.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                //            progressDialog.dismiss();
            }
        }        ){
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(change_profile_picture_technician.this);
