...
$conn = new mysqli($servername, $username, $password, $dbname);
 ...
 $ServerURL = "http://192.168.43.228:80//wumrts/technician/$ImagePath";
 $ServerURL1 = "http://192.168.43.228:80//wumrts/technician/$ImagePath1";
 
 
 
 
 
   $InsertSQL1 = "UPDATE technician SET imagepath='$ServerURL1' WHERE wuid='".$wuid."'";
