<?php 
	...
	$select1= "SELECT *from requests WHERE sender_wuid = 'wdu1200498'  AND task_status='Completed' AND report_status_client='reported' ORDER BY id desc";
			  ...
			  $index['assigned_date']    = $row['18'];
			   $index['requested_date']    = $row['19'];
			    $index['document_path']    = $row['20'];
				    $index['report_status']    = $row['21'];
					    $index['report_status_client']    = $row['22'];
