...
$ServerURL11 = "http://192.168.43.228:80//wumrts/request_sender/upload_dormitory_files/$trimmed1.docx";
 $dt = date('d-m-Y');
if($name=="")
{
...
$InsertSQL = "INSERT INTO requests (sender_wuid,name,buildingno,officeno,phone,additionalmessage,directoret,technician,techname,techphone,task_status,document_path,thing_to_fix,requested_date,report_status,report_status_client)
 values('$username1','$name','$bn','$of','$phone','$am','$fac','Not Assigned','Not Assigned','Not Assigned','Not Assigned','$ServerURL11','Dormitory','$current_date','not reported','not reported')";
 ...
 if($result){
	 ...
	 $action= $_POST["action"];
		 $logdata="username=".$action." = Requested for dormitory maintenances = ".$bn." ".$of." ".$phone." ".$name."".$facility." ".$am;
