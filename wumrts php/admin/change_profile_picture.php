...
$conn = new mysqli($servername, $username, $password, $dbname);
 ...
 $ServerURL1 = "http://192.168.43.228:80//wumrts/admin/$ImagePath1";
 
 
 
 
 
   $InsertSQL1 = "UPDATE admin SET imagepath='$ServerURL1' WHERE wuid='".$wuid."'";
 
 if(mysqli_query($conn, $InsertSQL1)){
 
$action=$_POST["action"];
   $logdata="username=".$action. " changed profile picture ";
